...
!(function (e) {
	...
	function M(M, P) {
		P = e.extend({}, P);
		var D = x || b || !P.fallbackToMouseEvents,
			L = D
				? b
					? S
						? "MSPointerDown"
			...
			k = D
				? b
					...
					: "touchend"
				: "mouseup",
			A = D ? (b ? "mouseleave" : "pointerleave") : "mouseleave",
			I = b ? (S ? "MSPointerCancel" : "pointercancel") : "touchcancel",
			U = 0,
			j = null,
			N = null,
			H = 0,
		...
		function te(e) {
			...
			if (V !== E && V !== m && !Se()) {
				...
				if (
					...
					2 == W &&
						(0 == _
							? (Oe(1, h[1]), (_ = q = Re(z[0].start, z[1].start)))
							: (Me(h[1]),
					...
					if (
						...
						(function (e, n) {
							if (e == a) return;
							(n = Math.max(n, Pe(e))), (X[e].distance = n);
						})(j, U),
						(c = ue(s, V)),
						...
						!P.triggerOnTouchEnd && T
							? (V = ae(y))
							: P.triggerOnTouchLeave && !T && (V = ae(E)),
							(V != m && V != E) || ue(s, V);
					}
				} else ue(s, (V = m));
				!1 === c && ue(s, (V = m));
		...
		function re(e) {
			...
			if (t) {
				if (t.length && !Se())
					return (
						(function (e) {
							(Z = Ae()), (J = e.touches.length + 1);
						})(n),
						!0
					);
				if (t.length && Se()) return !0;
			}
			return (
				Se() && (W = J),
				(G = Ae()),
		...
		function ie() {
			(W = 0), (G = 0), (B = 0), (_ = 0), (q = 0), (C = 1), xe(), be(!1);
		}
		function le(e) {
			var n = e.originalEvent ? e.originalEvent : e;
			P.triggerOnTouchLeave && ue(n, (V = ae(E)));
		}
		function oe() {
			Y.off(L, ne),
				Y.off(I, ie),
		...
		function ae(e) {
			...
			return (
				!t || i
					...
					? !r && e == E && P.triggerOnTouchLeave && (n = m)
					: (n = E),
				n
			);
		}
		function ue(e, n) {
			...
			return (
				((de() && we()) || we()) && (t = se(e, n, s)),
				((he() && ge()) || ge()) && !1 !== t && (t = se(e, n, c)),
				me() && Ee() && !1 !== t
					? (t = se(e, n, f))
					: H > P.longTapThreshold && U < v && P.longTap && !1 !== t
					? (t = se(e, n, h))
					: (1 !== W && x) ||
		...
		function se(a, u, g) {
			...
			if (g == c) {
				if (
					(Y.trigger("pinchStatus", [u, F || null, Q || 0, H || 0, W, C, z]),
					P.pinchStatus &&
						!1 ===
				...
				if (u == E && he())
					switch (F) {
						case l:
							Y.trigger("pinchIn", [F || null, Q || 0, H || 0, W, C, z]),
								P.pinchIn &&
									(d = P.pinchIn.call(
										Y,
										a,
							...
							break;
						case o:
							Y.trigger("pinchOut", [F || null, Q || 0, H || 0, W, C, z]),
								P.pinchOut &&
									(d = P.pinchOut.call(
										Y,
										a,
		...
		function he() {
			var e = ve(),
				n = Te(),
				t = null === P.pinchThreshold || Q >= P.pinchThreshold;
			return e && n && t;
		}
		function ge() {
		...
		function Se() {
			var e = !1;
			Z && Ae() - Z <= P.fingerReleaseThreshold && (e = !0);
			return e;
		}
		function be(e) {
			Y &&
		...
		(this.enable = function () {
			return this.disable(), Y.on(L, ne), Y.on(I, ie), Y;
		}),
			...
			(this.option = function (n, t) {
				if ("object" == typeof n) P = e.extend(P, n);
				else if (void 0 !== P[n]) {
					if (void 0 === t) return P[n];
					P[n] = t;
				} else {
					if (!n) return P;
